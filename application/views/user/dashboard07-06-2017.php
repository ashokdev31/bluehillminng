  ...
  $date2=strtotime('2018/06/08');
      ...
      <span id='timer'>
        <div class="countdown-box">
          <div class="token-countdown d-flex align-content-stretch animated fadeInUp" data-zone="<?php echo date_default_timezone_get();?>" data-animate="fadeInUp" data-delay="2.05" data-date="<?php echo date('Y/m/d', time()+86400);?>">
          </div> 
