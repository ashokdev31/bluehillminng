        ...
        <div class="row">
          <div class="col-md-6 col-xs-12">
            <div class="left_left full_left">
              ...
              <div class="bunny">
                <h1 data-attr="<?php echo (!empty($calculatebunny))?$calculatebunny[0]->Total:"0";?>"><?php  echo (!empty($calculatebunny))?$calculatebunny[0]->Total:"0";?> BHMBLU</h1>
              ...
              <ul class="big_btnn">
                ...
                <div class="contract-info1">
                  <span>BHMBLU Hill Contract Address</span>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>+<?php echo $result1->bunny;?>  BHMBLU</td>
       ...
       <div class="payment">
        ...
        <div class="row">
          ...
          <div class="col-total">
            <div class="fields">
              <div class="price">
                <div class="bunny-price">5000</div><span class="symbol"> BHMBLU</span>
              </div>
              <div class="equals">+</div>
              <div class="price"> <div class="bonus-amount active">10% </div><span class="symbol">BONUS</span></div>
              <div class="equals">=</div>
              <div class="price"> <div class="total-sum">5877 </div><span class="symbol"> BHMBLU</span></div>
            </div>
          </div>
          <div class="input-text"><span>1000 BHMBLU minimum purchase</span></div>
        </div>
        <div class="row progress-bar-row">
          <div class="col-full">
           ...
           <!--  <div class="button-wrapper">
                <div class="content"><a href="https://www.myetherwallet.com/?to=0xc81a355bddb646c003637372634f36a94b5e5b2c&amp;value=1&amp;gas=21000&amp;gasprice=12x#send-transaction" target="_blank" class="button BHMBLU undefined   "><span></span><span>MyEtherWallet</span></a></div>
              </div> -->
              <div class="button-wrapper">
                <div class="content"><button class="button BHMBLU undefined transferFunds" type="button"><span></span><span>MetaMask</span></button></div>
              </div>
            </div>
          </div>
        </div>
       ...
       <div class="payment">
        ...
        <div class="row">
          ...
          <div class="col-total">
            <div class="fields">
              <div class="price">
                <div class="bunny-price">60.399</div><span class="symbol"> BHMBLU</span>
              </div>
              <div class="equals">+</div>
              <div class="price"> <div class="bonus-amount active">75% </div><span class="symbol">BONUS</span></div>
              <div class="equals">=</div>
              <div class="price"> <div class="total-sum">105.698</div><span class="symbol"> BHMBLU</span></div>
            </div>
          </div>
          <div class="input-text"><span>1000 BHMBLU minimum purchase</span></div>
        </div>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="contract-address"><h2 class="personal-header"><span>BHMBLU Hill Contract Address</span></h2>
                          <div class="input  "><input type="text" id="blucont" autocomplete="on" value="0x97433f49c97bef8dbeced06290a1c241886255dc" readonly="">
                            <div class="box">Copied!</div><div class="errors"></div>
                          </div>
                          <span class="copy_text">Copy this address to your wallet to view your BHMBLU tokens.<br>
...
web3.eth.getAccounts(function(error, accounts) {
  if (!error) {
    ...
    web3.eth.getBalance(accounts[0], function(error, balance) {
      ...
      var tokenContract = web3.eth.contract(priceFeedAbi).at("0x97433f49c97bef8dbeced06290a1c241886255dc");
